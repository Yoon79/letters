        ...
        <div className="space-y-4 pt-5">
          ...
          <div
            ...
            <p className="font-suit">
              ...
              <br />
              <br />
              앨범이 미뤄진 게 조금 아쉬웠는데 덕분에 &apos;새벽이&apos;를 넣게
              됐으니까 아무튼 좋아!
              <br />
              <br />
              생각해 보면 12년 동안 앨범을 만들면서 트랙에 맞춰 필요한 곡들을
              쓰기 위해 애썼던 것 같아. &apos;3번 트랙에 있으면 좋을법한 귀여운
              노래&apos; 랄지 &apos;마지막 트랙을 장식할 만한 분위기의
              노래&apos; 같은 거. 그렇게 잘 맞물리는 일들이 좋기도 했고!
              <br />
              <br />
              근데 이번 앨범은 좀... [From. Paris] 만들던 때가 생각나! 한껏
              자유롭고 초롱초롱하던 23살 그때의 기분이야. 그때 우리, 고민은 별로
              없고 아이디어는 넘쳤었는데 그치? 미화된 건가.. 호호
              <br />
              <br />
              뭐였지(의식의 흐름대로 쓰는 중이야)
              <br />
          ...
          <div
            ...
            <p className="font-sans">
              ...
              <br />
              카페에 커피를 테이크아웃하러 가다 옆에 있는 치과에 가서 스케일링을
              받고(무의식에 깔려있던 투 두 리스트도 아니었는데), 자동차에 두고
              온 가방을 가지러 갔다가 한밤중에 드라이브를 하고, 지금은 계란 사러
              하나로마트를 가다 도서관에 와서 우표와 관련된 책을 단숨에 다
              읽어버렸어(이 책마저도 충동적으로 빈자리에 가까이 꽂혀있던 책을
              집은 거야).
              <br />
              <br />
              ...
              [From. Paris] 만들던 그때!
              <br />
              우리가 처음으로 아이스 아메리카노를 마시게 되었을 때. 모든 말을 다
              솔직히 하지 않아도 된다는 걸 알았을 때. 하나의 물건이 빛의 방향에
              따라 그림자는 다르다는 걸 알았을 때. 행복해서 불안하다는 것을
              알았을 때. 생각보다 행동이 많던 때. 설레임, 떨림.
              <br />
              <br />
              ...
              그렇게 한 번씩 신들린 듯이 공책에 음표를 막힘없이 휘갈길 때면 나는
              아주 긴장돼. 뿌뿌도 조용히 시킬 정도야. 니 말대로 그 곡을 넣을 수
              있게 되어 나도 기뻐. 아직은 들을수록 ‘내일 작업실에서 이 부분
              이렇게 고쳐야겠다’하는 생각이 더 많이 들지만! 발매하고 들어도
              어딘가는 또 아쉽겠지. 앗! 이틀 동안 고양이랑만 대화해서 그런가
              내가 말이 너무 많았네. 급히 줄일게.
              <br />
              <br />
              와, 역시 도서관에서 보는 석양은 유난히 멋있어. 내가 아까 읽었다던
              책 기억나?(그 작가분도 창원에서 사셨나 봐 키키. 이런 우연이~) 그
              책 마지막 부분 내용에 (((스포주의))) 1년 뒤 나에게 보낼 편지를
              쉽게 써내지 못하는 장면이 나오는데, 그게 너무 지금의 나 같아. 알
              수 없어서 불안하기도 하지만 동시에 굉장히 설레기도 해!
              <br />
              <br />
              우린 또 어떤 노래를 만들게 될까?
              <br />
